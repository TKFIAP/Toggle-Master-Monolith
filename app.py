...
def delete_flag(name):
    try:
        ...
        return jsonify({"error": "Erro interno ao deletar a flag", "details": str(e)}), 500
    ...
    return jsonify({"message": f"Flag '{name}' deletada com sucesso"}), 200
